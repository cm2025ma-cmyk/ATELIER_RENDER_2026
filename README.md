...
**Architecture cible :** Ci-dessous, voici l'architecture cible souhaitéee.   
...
Difficulté : Faible (~10 minutes)
---------------------------------------------------
Procédez à la modification de ce README.md (CHO-LIN Matthieu) et Commitez. La création du Service Web Render est automatique.  
